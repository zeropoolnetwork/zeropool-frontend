...
describe('LowBalanceHelper', () => {
    describe('lowPublicBalance', () => {
        it('should retunt false if enough funds', () => {
            ...
            expect(lowBalanceHelper(transferType, amount, publicBalance, tokenBalance, privateBalance)).toBe(false);
        });
        ...
        it(`should return true if not enough funds`, () => {
            ...
            const tokenBalance = '0.3';
            const privateBalance = '0.4';
            expect(lowBalanceHelper(transferType, amount, publicBalance, tokenBalance, privateBalance)).toBe(true);
        })
    });
    ...
    describe(`should return true if low privateBalance`, () => {
        it(`privateToPrivate`, () => {
            const transferType = 'privateToPrivate';
            const amount = '0.1';
            const publicBalance = '0.2';
            const tokenBalance = '0.3';
