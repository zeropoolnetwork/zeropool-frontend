...
import { Wellcome, componentId, WellcomeProps } from './Wellcome';

describe('Wellcome Page', () => {
  let outputSpy: jest.Mock;
  let component: React.ReactElement<WellcomeProps>;
  afterEach(cleanup);

  beforeEach(() => {
    outputSpy = jest.fn();
    component = <Wellcome onAbout={outputSpy} onCreate={outputSpy} onImport={outputSpy} />;
  });
